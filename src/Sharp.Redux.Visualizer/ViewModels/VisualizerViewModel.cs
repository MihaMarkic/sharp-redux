...
{
    public class VisualizerViewModel : NotificableObject
    {
        ...
        public VisualizerViewModel(IReduxDispatcher sourceDispatcher)
        {
        ...
        public void StateChanged(VisualizerState state)
        {
            this.state = state;
