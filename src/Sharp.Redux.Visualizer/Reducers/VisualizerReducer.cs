...
{
    public class VisualizerReducer : IReduxReducer<VisualizerState>
    {
        public async Task<VisualizerState> ReduceAsync(VisualizerState state, ReduxAction action, CancellationToken ct)
        {
            VisualizerState result;
            switch (action)
            {
